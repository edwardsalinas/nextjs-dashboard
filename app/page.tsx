    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <div
            className="relative w-0 h-0 border-l-[25px] border-r-[25px] border-b-[36px] border-l-transparent border-r-transparent border-b-black"
          />
          <div className={ `${style.shape} ${style.shape1}`} />
          <h1 className={ style.title }>Hola nextjs</h1>
